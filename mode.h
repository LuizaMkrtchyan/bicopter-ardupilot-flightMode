...
public:
    ...
    enum class Number : uint8_t {
        ...
        BICOPTER =     29,  // Balancing Bicopter
...
class ModeBicopter : public Mode{
public:
    using Mode::Mode;
    Number mode_number() const override { return Number::BICOPTER; }

    bool init(bool ignore_checks) override;
    virtual void run() override;

     PID my_angle_pid{1,0,0};
     PID my_rate_pid{2,0,0};
     PID my_accel_pid{1,0,0};
...
//for logging and display purposes
    const char *name() const override { return "BICOPTER"; }
    const char *name4() const override { return "BICO"; }
